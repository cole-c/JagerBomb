...
public class Pair<X, Y> {
	...
	public static <A, B> Comparator<Pair<A, B>> orderByFirst(
			final Comparator<A> firstComp, final Comparator<B> secondComp) {
	...
	public static <A, B> Comparator<Pair<A, B>> orderBySecond(
			final Comparator<A> firstComp, final Comparator<B> secondComp) {
		return new Comparator<Pair<A, B>>() {
			public int compare(Pair<A, B> p1, Pair<A, B> p2) {
	...
	public String toString() {
		return new StringBuffer().append('<').append(first).append(',')
	...
	public boolean equals(Object o) {
		// if the references point to the same object (same memory location),
		// return true
		if (this == o)
			return true;
		...
		boolean firstsEqual = this.first == null ? p.first == null : this.first
				.equals(p.first);
		boolean secondsEqual = this.second == null ? p.second == null
